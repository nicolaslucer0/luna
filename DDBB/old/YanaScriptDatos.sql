...
('Trastornos de la conducta alimentaria, sexuales, sue�o, etc','',0,getdate(),1),
('Trastornos de ansiedad','',0,getdate(),1),
...
(6,'Hermana',4,'Mala Relaci�n',0,getdate(),1);
...
values
(3,'Rendir un parcial','Bajo rendimiento',7,90,'Pensar que la facultad no es para mi',80,'Pedir ayuda a compa�eros',50,50,1,0,getdate(),1),
